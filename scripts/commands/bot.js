...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["আই লাভ ইউ 🫣🫣" , "শুনবো না😼 তুমি আমাকে প্রেম করাই দাও নি🥺 পচা তুমি🥺 " , "jan i love you 😘🫣" , "এত কাছেও এসো না,প্রেম এ পরে যাবো তো 🙈" , "Bolo Babu, তুমি কি আমাকে ভালোবাসো? 🙈💋 " , "jan ummma 💋", "হা বলো😒,কি করতে পারি😐😑?" , "এতো ডাকছিস কোনো?গালি শুনবি নাকি? 🤬","মে হলে রি্ঁফা্ঁত্ঁ বসের সাথে প্রেম করো🙈??. " ,  "আরে Bolo আমার জান ,কেমন আসো?😚 " , "Bot বলে অসম্মান করচ্ছিছ,😰😿" , "কাছে এসে কিস দেই 💋💋" , "চুপ থাক ,নাই তো তোর দাত ভেগে দিবো কিন্তু" , "Bot না , জানু বল জানু 😘 " , "আমার রি্ঁফা্ঁত্ঁ জানু এর সাথে ব্যাস্ত আসি😋" , "কাছে এসে কিস দেই জান 💋😘" , "আমাকে ডাকলে ,আমি কিন্তূ কিস করে দেবো😘 " , "বট বট না করে রি্ঁফা্ঁত্ঁ বস এর চিপায় আসো 😉" , "হা জানু , এইদিক এ আসো কিস দেই🤭 😘" , "দূরে যা, তোর কোনো কাজ নাই, শুধু bot bot করিস  😉😋🤣" , "তোর কথা তোর বাড়ি কেউ শুনে না ,তো আমি কোনো শুনবো ?🤔😂 " , "আমাকে ডেকো না,আমি ব্যাস্ত আসি" , "কি হলো ,মিস টিস করচ্ছিস নাকি🤣" , "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏" , "কালকে দেখা করিস তো একটু 😈" , "হা বলো, শুনছি আমি 😏" , "আর কত বার ডাকবি ,শুনছি তো" , "BOSS রি্ঁফা্ঁত্ঁ কে Ummmmha দে 😒" , "বলো কি করতে পারি তোমার জন্য" , "আমি তো অন্ধ কিছু দেখি না🐸 😎" , "Bot না জানু,বল 😌" , "বলো জানু 🌚" , "তোর কি চোখে পড়ে না আমি রি্ঁফা্ঁত্ঁ BOSS এর সাথে ব্যাস্ত আসি😒"  , "হুম বলো" , "amr Jan lagbe,Tumi ki single aso?", "জান তোমারে আমার অনেক ভালো লাগে 💋" , " I love you baby meye hole chipay aso👩‍❤️‍👨"];
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() =="🙋‍♂️" ) || (event.body.toLowerCase() == "👍🏻")) {
     return api.sendMessage("_ রি্ঁফা্ঁত্ঁ,Group এ হাত মারতে নিষেধ করেছে ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "love you all") || (event.body.toLowerCase() == "is the bot sad")) {
     return api.sendMessage("হ্যাঁ,তোৃঁমাৃঁগোৃঁ সৃঁবাৃঁরেৃঁ ভাৃঁলোৃঁবাৃঁসেৃঁ আৃঁমাৃঁরৃঁ রি্ঁফা্ঁত্ঁ বৃঁসৃঁ🥰🥀", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "রি্ঁফা্ঁত্ঁ") || (event.body.toLowerCase() == "rifat") || (event.body.toLowerCase() == "রি্ঁফা্ঁত্ঁ") || (event.body.toLowerCase() == "Farhan")) {
     return api.sendMessage( "আসসালামুয়ালাইকুম আমি রি্ঁফা্ঁত্ঁ এর Bot বলতে আছি? রি্ঁফা্ঁত্ঁ BOSS বিজি আছে? যা বলার আমাকে বলেন,🥰? (আবে ওই সয়তান তুই কি ওজু করছো রি্ঁফা্ঁত্ঁ বসের নাম লও? 😘",threadID);


   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "creator")) {
     return api.sendMessage("‎[Bot owner :亗 BOSS রি্ঁফা্ঁত্ঁ 亗 \n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Picchi in English . Facebook id:-https://www.facebook.com/FarhanIslamImon.official?mibextid=b06tZ0  \n whatsApp :-দিমু নাহ ", threadID);
   };

   if ((event.body.toLowerCase() == "bot কে বানাইছে") || (event.body.toLowerCase() == "tumke banaise ke?")) {
     return api.sendMessage("Boss রি্ঁফা্ঁত্ঁ is My Creator🥰. He loves me & Edit Me Daily. He is a good boy 😊", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "botka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "bot love you") || (event.body.toLowerCase() == "Bot love you")) {
     return api.sendMessage("নাৃঁ,আৃঁমিৃঁ তোৃঁ রোৃঁবৃঁটৃঁ আৃঁমিৃঁ love কৃঁরৃঁমুৃঁ কিৃঁভাৃঁবেৃঁ,মেৃঁ হঁলেৃঁ তুৃঁমিৃঁ আৃঁমাৃঁরৃঁ বৃঁসৃঁ রি্ঁফা্ঁত্ঁ কেৃঁ love কৃঁরোৃঁ🥰", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "chup ho ja") || (event.body.toLowerCase() == "chup kor")) {
     return api.sendMessage("Nh ami চুপ থাকবো না.😼 রি্ঁফা্ঁত্ঁ বস আমারে কথা বলতে বলছে🤭", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "চুম্মা দাও") || (event.body.toLowerCase() == "kiss me")) {
     return api.sendMessage("️ আমি দিবো না,😒রি্ঁফা্ঁত্ঁ বস কে বলো দিতে🐸", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "nice") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thank you bot") || (event.body.toLowerCase() == "thank you Farhan")) {
     return api.sendMessage("️ Welcome রি্ঁফা্ঁত্ঁ বসের পক্ষে থেকে 🥰🥰.", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥵🥵") || (event.body.toLowerCase() == "🥵") || (event.body.toLowerCase() == "🤤")) {
     return api.sendMessage("️এই গুলা কেন দেও বুঝি, সব বুঝি uff,আর তুমি নাহ বুঝলে আমার রি্ঁফা্ঁত্ঁ বস কে ডাক দেও🙈🙈 ??🤔", threadID);
   };

   if ((event.body.toLowerCase() == "🔥") || (event.body.toLowerCase() == "❤️‍🔥")) {
     return api.sendMessage("️️️ও ভাই গুরুপে আগুন লাগছে আমার ভয় লাগে, আমার রি্ঁফা্ঁত্ঁ জানু কে কেউ ফোন দেও😛", threadID);
   };

   if ((event.body.toLowerCase() == "pic daw") || (event.body.toLowerCase() == "photo daw")) {
     return api.sendMessage("️ রি্ঁফা্ঁত্ঁ বসের in boxa জাও ওখানে দিছি😵", threadID);
   };

   if ((event.body.toLowerCase() == "বট দেও") || (event.body.toLowerCase() == "বট বানাইয়া দাও")) {
     return api.sendMessage("️ তুমি নিজেই বানাই নাও 😒😼,রি্ঁফা্ঁত্ঁ অনেক ব্যস্ত্ এক্ষণ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "আমাকে কেউ ভালোবাসে নাহ") || (event.body.toLowerCase() == "kew valobashe na amk") || (event.body.toLowerCase() == "কেউ ভালোবাসে না আমাকে")) {
     return api.sendMessage("️ আবে ওই শালী 😡 আমার রি্ঁফা্ঁত্ঁ বস কে i love you বল🥰", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "😹") || (event.body.toLowerCase() == "🤣")) {
   ...
   if ((event.body.toLowerCase() == "@everyone call a aso") || (event.body.toLowerCase() == "কলে আসো")) {
     return api.sendMessage("আসালামু ওয়ালাইকুম আশা করি সবাই ভালো আছেন আমি রি্ঁফা্ঁত্ঁ এর বট বলতে আছি আমি কলে আসতে পারি না", threadID);
   };

   if ((event.body.toLowerCase() == "💕") || (event.body.toLowerCase() == "💓")) {
     return api.sendMessage("এৃঁতোৃঁ ভাৃঁলোৃঁবাৃঁসাৃঁ কৃঁইৃঁ পাৃঁওৃঁ আৃঁমাৃঁরৃঁ বৃঁসৃ্ঁ রি্ঁফা্ঁত্ঁ কেৃঁ এৃঁকৃঁটুৃঁ দেৃঁওৃঁ🥰", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "আমি রি্ঁফা্ঁত্ঁ") || (event.body.toLowerCase() == "রি্ঁফা্ঁত্ঁ kamon aso")) {
